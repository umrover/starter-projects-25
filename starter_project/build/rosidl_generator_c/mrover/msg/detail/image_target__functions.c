...
mrover__msg__ImageTarget__init(mrover__msg__ImageTarget * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    mrover__msg__ImageTarget__fini(msg);
    return false;
  }
  // bearing
  return true;
...
mrover__msg__ImageTarget__create()
{
  ...
  mrover__msg__ImageTarget * msg = (mrover__msg__ImageTarget *)allocator.allocate(sizeof(mrover__msg__ImageTarget), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrover__msg__ImageTarget));
  bool success = mrover__msg__ImageTarget__init(msg);
  if (!success) {
...
mrover__msg__ImageTarget__Sequence__init(mrover__msg__ImageTarget__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrover__msg__ImageTarget * data = NULL;

  if (size) {
    data = (mrover__msg__ImageTarget *)allocator.zero_allocate(size, sizeof(mrover__msg__ImageTarget), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrover__msg__ImageTarget__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mrover__msg__ImageTarget__fini(&data[i - 1]);
      }
...
mrover__msg__ImageTarget__Sequence__fini(mrover__msg__ImageTarget__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mrover__msg__ImageTarget__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrover__msg__ImageTarget__Sequence * array = (mrover__msg__ImageTarget__Sequence *)allocator.allocate(sizeof(mrover__msg__ImageTarget__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrover__msg__ImageTarget__Sequence__init(array, size);
  if (!success) {
...
mrover__msg__ImageTarget__Sequence__destroy(mrover__msg__ImageTarget__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrover__msg__ImageTarget__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrover__msg__ImageTarget__Sequence__are_equal(const mrover__msg__ImageTarget__Sequence * lhs, const mrover__msg__ImageTarget__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrover__msg__ImageTarget__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrover__msg__ImageTarget__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrover__msg__ImageTarget);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrover__msg__ImageTarget * data =
      (mrover__msg__ImageTarget *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrover__msg__ImageTarget__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrover__msg__ImageTarget__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrover__msg__ImageTarget__copy(
