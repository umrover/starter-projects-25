...
#include "mrover/msg/detail/calibration_status__rosidl_typesupport_fastrtps_c.h"
...
using _CalibrationStatus__ros_msg_type = mrover__msg__CalibrationStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: magnetometer_calibration
  {
    cdr << ros_message->magnetometer_calibration;
  }

  // Field name: gyroscope_calibration
  {
    cdr << ros_message->gyroscope_calibration;
  }

  // Field name: acceleration_calibration
  {
    cdr << ros_message->acceleration_calibration;
  }
...
size_t get_serialized_size_mrover__msg__CalibrationStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CalibrationStatus__ros_msg_type * ros_message = static_cast<const _CalibrationStatus__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name magnetometer_calibration
  {
    size_t item_size = sizeof(ros_message->magnetometer_calibration);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name gyroscope_calibration
  {
    size_t item_size = sizeof(ros_message->gyroscope_calibration);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name acceleration_calibration
  {
    size_t item_size = sizeof(ros_message->acceleration_calibration);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _CalibrationStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrover__msg__CalibrationStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrover
size_t max_serialized_size_mrover__msg__CalibrationStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrover__msg__CalibrationStatus;
    is_plain =
      (
      offsetof(DataType, acceleration_calibration) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _CalibrationStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrover__msg__CalibrationStatus(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrover, msg, CalibrationStatus)() {
