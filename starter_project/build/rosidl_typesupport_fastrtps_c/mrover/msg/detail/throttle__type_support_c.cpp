...
#include "mrover/msg/detail/throttle__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // throttles
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // throttles
...
using _Throttle__ros_msg_type = mrover__msg__Throttle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = ros_message->throttles.size;
    auto array_ptr = ros_message->throttles.data;
    cdr << static_cast<uint32_t>(size);
  ...
  void * untyped_ros_message)
{
  ...
  _Throttle__ros_msg_type * ros_message = static_cast<_Throttle__ros_msg_type *>(untyped_ros_message);
  // Field name: names
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
  ...
  // Field name: throttles
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->throttles.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->throttles);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->throttles, size)) {
      fprintf(stderr, "failed to create array for field 'throttles'");
      return false;
    }
    auto array_ptr = ros_message->throttles.data;
...
size_t get_serialized_size_mrover__msg__Throttle(
  const void * untyped_ros_message,
...
static uint32_t _Throttle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrover__msg__Throttle(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrover
size_t max_serialized_size_mrover__msg__Throttle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrover__msg__Throttle;
    is_plain =
      (
...
static size_t _Throttle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrover__msg__Throttle(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrover, msg, Throttle)() {
