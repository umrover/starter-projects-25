...
bool mrover__msg__velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrover.msg._velocity.Velocity", full_classname_dest, 29) == 0);
  }
  mrover__msg__Velocity * ros_message = _ros_message;
  {  // names
...
PyObject * mrover__msg__velocity__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrover.msg._velocity");
