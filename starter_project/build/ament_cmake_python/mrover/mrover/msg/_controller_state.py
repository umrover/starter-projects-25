...
class ControllerState(metaclass=Metaclass_ControllerState):
    ...
    def __init__(self, **kwargs):
        ...
        self.limit_hit = array.array('B', kwargs.get('limit_hit', []))
    ...
    def __eq__(self, other):
        ...
        if self.error != other.error:
            return False
        if self.limit_hit != other.limit_hit:
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, str) for v in value) and
                 True), \
                "The 'error' field must be a set or sequence and each value of type 'str'"
        self._error = value

    @builtins.property
    def limit_hit(self):
        """Message field 'limit_hit'."""
        return self._limit_hit

    @limit_hit.setter
    def limit_hit(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'B', \
                "The 'limit_hit' array.array() must have the type code of 'B'"
            self._limit_hit = value
            return
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ...
                "The 'limit_hit' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 255]"
        self._limit_hit = array.array('B', value)
