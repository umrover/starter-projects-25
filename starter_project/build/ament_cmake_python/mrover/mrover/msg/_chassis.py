...
class Chassis(metaclass=Metaclass_Chassis):
    ...
    def __init__(self, **kwargs):
        ...
        self.omega_r = kwargs.get('omega_r', float())
        self.omega_l = kwargs.get('omega_l', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.omega_r != other.omega_r:
            return False
        if self.omega_l != other.omega_l:
            return False
        return True
    ...
    @builtins.property
    def omega_r(self):
        """Message field 'omega_r'."""
        return self._omega_r

    @omega_r.setter
    def omega_r(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'omega_r' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'omega_r' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._omega_r = value

    @builtins.property
    def omega_l(self):
        """Message field 'omega_l'."""
        return self._omega_l

    @omega_l.setter
    def omega_l(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'omega_l' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'omega_l' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._omega_l = value
