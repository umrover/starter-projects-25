...
bool mrover__msg__can__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrover.msg._can.CAN", full_classname_dest, 19) == 0);
  }
  mrover__msg__CAN * ros_message = _ros_message;
  {  // source
  ...
  {  // reply_required
    PyObject * field = PyObject_GetAttrString(_pymsg, "reply_required");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->reply_required = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * mrover__msg__can__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrover.msg._can");
  ...
  {  // reply_required
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->reply_required ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "reply_required", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
