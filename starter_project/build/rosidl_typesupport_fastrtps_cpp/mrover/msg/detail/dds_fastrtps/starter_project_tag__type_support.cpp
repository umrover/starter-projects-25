...
#include "mrover/msg/detail/starter_project_tag__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrover::msg::StarterProjectTag & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrover::msg::StarterProjectTag & ros_message)
{
  // Member: tag_id
  cdr >> ros_message.tag_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrover
max_serialized_size_StarterProjectTag(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrover::msg::StarterProjectTag;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrover::msg::StarterProjectTag *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrover::msg::StarterProjectTag *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StarterProjectTag__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrover::msg::StarterProjectTag *>(
...
static size_t _StarterProjectTag__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StarterProjectTag(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _StarterProjectTag__callbacks = {
  "mrover::msg",
  "StarterProjectTag",
...
static rosidl_message_type_support_t _StarterProjectTag__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StarterProjectTag__callbacks,
...
{
  return &mrover::msg::typesupport_fastrtps_cpp::_StarterProjectTag__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrover, msg, StarterProjectTag)() {
  return &mrover::msg::typesupport_fastrtps_cpp::_StarterProjectTag__handle;
}
