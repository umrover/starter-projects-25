...
#include "mrover/msg/detail/controller_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrover::msg::ControllerState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrover::msg::ControllerState & ros_message)
{
  // Member: name
  {
    cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  // Member: error
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.error[index].size() + 1);
    }
  }
  // Member: limit_hit
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.limit_hit[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrover::msg::ControllerState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrover::msg::ControllerState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrover::msg::ControllerState *>(
    untyped_ros_message);
...
{
  return &mrover::msg::typesupport_fastrtps_cpp::_ControllerState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrover, msg, ControllerState)() {
  return &mrover::msg::typesupport_fastrtps_cpp::_ControllerState__handle;
}
