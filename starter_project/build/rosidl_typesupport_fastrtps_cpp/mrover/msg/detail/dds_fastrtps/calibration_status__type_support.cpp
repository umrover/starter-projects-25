...
#include "mrover/msg/detail/calibration_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrover::msg::CalibrationStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrover::msg::CalibrationStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrover::msg::CalibrationStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrover::msg::CalibrationStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrover::msg::CalibrationStatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<mrover::msg::CalibrationStatus>()
{
  return &mrover::msg::typesupport_fastrtps_cpp::_CalibrationStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrover, msg, CalibrationStatus)() {
  return &mrover::msg::typesupport_fastrtps_cpp::_CalibrationStatus__handle;
}
