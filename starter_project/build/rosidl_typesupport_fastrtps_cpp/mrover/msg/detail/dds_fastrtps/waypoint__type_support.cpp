...
#include "mrover/msg/detail/waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrover::msg::Waypoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrover::msg::Waypoint & ros_message)
{
  // Member: tag_id
  cdr >> ros_message.tag_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrover::msg::Waypoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrover::msg::Waypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrover::msg::Waypoint *>(
    untyped_ros_message);
...
{
  return &mrover::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrover, msg, Waypoint)() {
  return &mrover::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
