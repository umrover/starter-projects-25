...
#include "mrover/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrover::msg::Position & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrover::msg::Position & ros_message)
{
  // Member: names
  {
    cdr >> ros_message.names;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrover::msg::Position;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrover::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrover::msg::Position *>(
    untyped_ros_message);
...
{
  return &mrover::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrover, msg, Position)() {
  return &mrover::msg::typesupport_fastrtps_cpp::_Position__handle;
}
