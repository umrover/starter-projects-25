...
{
  new (message_memory) mrover::msg::CAN(_init);
}

void CAN_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mrover::msg::CAN *>(message_memory);
  typed_message->~CAN();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CAN_message_member_array[4] = {
  {
    "source",  // name
    ...
    offsetof(mrover::msg::CAN, source),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrover::msg::CAN, destination),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrover::msg::CAN, data),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrover::msg::CAN, reply_required),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::mrover::msg::rosidl_typesupport_introspection_cpp::CAN_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrover, msg, CAN)() {
  return &::mrover::msg::rosidl_typesupport_introspection_cpp::CAN_message_type_support_handle;
}
