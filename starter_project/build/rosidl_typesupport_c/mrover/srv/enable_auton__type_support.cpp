...
static const _EnableAuton_Request_type_support_symbol_names_t _EnableAuton_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrover, srv, EnableAuton_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mrover, srv, EnableAuton_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mrover, srv, EnableAuton_Request)() {
  return &::mrover::srv::rosidl_typesupport_c::EnableAuton_Request_message_type_support_handle;
}
...
static const _EnableAuton_Response_type_support_symbol_names_t _EnableAuton_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrover, srv, EnableAuton_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mrover, srv, EnableAuton_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mrover, srv, EnableAuton_Response)() {
  return &::mrover::srv::rosidl_typesupport_c::EnableAuton_Response_message_type_support_handle;
}
...
static const _EnableAuton_type_support_symbol_names_t _EnableAuton_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrover, srv, EnableAuton)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mrover, srv, EnableAuton)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mrover, srv, EnableAuton)() {
  return &::mrover::srv::rosidl_typesupport_c::EnableAuton_service_type_support_handle;
}
