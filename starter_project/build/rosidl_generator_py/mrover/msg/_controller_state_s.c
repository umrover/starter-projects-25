...
bool mrover__msg__controller_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrover.msg._controller_state.ControllerState", full_classname_dest, 44) == 0);
  }
  mrover__msg__ControllerState * ros_message = _ros_message;
  {  // name
  ...
  {  // error
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->error.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // limit_hit
    PyObject * field = PyObject_GetAttrString(_pymsg, "limit_hit");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->limit_hit.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'limit_hit'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * mrover__msg__controller_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrover.msg._controller_state");
  ...
  {  // error
    ...
    rosidl_runtime_c__String * src = ros_message->error.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // limit_hit
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "limit_hit");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->limit_hit.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->limit_hit.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->limit_hit.size * sizeof(uint8_t));
      assert(data != NULL);
