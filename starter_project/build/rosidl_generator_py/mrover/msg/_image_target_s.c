...
bool mrover__msg__image_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrover.msg._image_target.ImageTarget", full_classname_dest, 36) == 0);
  }
  mrover__msg__ImageTarget * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of ImageTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrover.msg._image_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImageTarget");
